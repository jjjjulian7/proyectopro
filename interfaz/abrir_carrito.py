...
def abrir_carrito():
    ...
    frame_lista_carrito = tk.Frame(parte_derecha, bg="#d9d9d9")
    ...
    lbl_tarjeta = tk.Label(parte_izquierda, text="Número Tarjeta", bg="#d9d9d9") 
    lbl_tarjeta.grid(row=0, column=0, padx=(20, 10), pady=(210, 10), sticky="e") 

    nroTarjeta = tk.Entry(parte_izquierda) 
    nroTarjeta.grid(row=0, column=1, columnspan=3, pady=(210, 10), sticky="w") 

    lbl_fecha = tk.Label(parte_izquierda, text="Fecha Vencimiento", bg="#d9d9d9") 
    lbl_fecha.grid(row=1, column=0, padx=(20, 10), pady=(0, 10), sticky="e") 

    FechaIngresoMes = tk.Entry(parte_izquierda, width=4) 
    ...
    FechaIngresoAno = tk.Entry(parte_izquierda, width=4) 
    FechaIngresoAno.grid(row=1, column=3, padx=(0, 0), pady=(0, 10), sticky="w") 

    lbl_cvv = tk.Label(parte_izquierda, text="CVV", bg="#d9d9d9") 
    lbl_cvv.grid(row=2, column=0, padx=(20, 10), pady=(0, 10), sticky="e") 

    IngresoCvv = tk.Entry(parte_izquierda, width=4) 
    IngresoCvv.grid(row=2, column=1, sticky="w") 

    btn_validar = tk.Button(parte_izquierda, text="Comprar", command=validar_datos) 
